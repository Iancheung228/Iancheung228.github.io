...
The 2 sample t-test is a very common test to determine whether the difference we observe is real or just due to noise. It is based on the t-statistic  $$ \frac{\Delta}{\sqrt{var(\Delta)}}$$ where $$\Delta = \overline{Y^t} - \overline{Y^c} $$
